...
Next, now that we have our player character "moving" in an animated run cycle, we'll get them moving in a new way, jumping! This will be done with an "acceleration" sort of movement.
